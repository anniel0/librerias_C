...
typedef struct
{
    ...
    size_t size_data; // Tamano de cada elemento en bytes
 ...
 * @param size_data Tamano en bytes de cada elemento
 * @return Cola inicializada
 * @note La cola debe ser liberada con queue_clear cuando ya no se use
 */
 ...
 * @param size_data Tamano en bytes de los datos
 * @return Puntero al nuevo nodo o NULL en caso de error de memoria
 */
 ...
 * @return 1 si se encolo correctamente, 0 en caso de error
 * @note Complejidad temporal: O(1)
 * @note Se asigna nueva memoria para el nodo
 */
 ...
 * @param q Puntero a la cola
 * @return 1 si se desencolo correctamente, 0 si la cola esta vacia
 * @note Complejidad temporal: O(1)
 * @note Libera la memoria del nodo eliminado
 */
int dequeue(queue *q);
 ...
 * @note Complejidad temporal: O(n) donde n es el numero de elementos
 * @note Libera toda la memoria de los nodos
 */
 ...
 * @note La funcion callback debe aceptar un puntero void como parametro
 * @note Ejemplo: queue_traverse(mi_cola, mi_funcion_impresion);
 * @note Complejidad temporal: O(n) donde n es el numero de elementos
 */
 ...
 * @note La funcion compare debe seguir la semantica de strcmp
 */
 ...
 * @note Ambas colas deben tener el mismo size_data
 * @note Asigna nueva memoria para todos los nodos copiados
 */
